...
def load_font(size: int, bold: bool = False) -> ImageFont.FreeTypeFont:
    ...
    candidates = [
        ...
        windows_fonts / ("YuGothB.ttc" if bold else "YuGothR.ttc"),
        windows_fonts / ("meiryob.ttc" if bold else "meiryo.ttc"),
        Path("/usr/share/fonts/opentype/noto/NotoSansCJK-Bold.ttc" if bold else "/usr/share/fonts/opentype/noto/NotoSansCJK-Regular.ttc"),
        Path("/usr/share/fonts/truetype/noto/NotoSansJP-Bold.ttf" if bold else "/usr/share/fonts/truetype/noto/NotoSansJP-Regular.ttf"),
    ]
